 ...
 * "M248_LUT", a look up table for the MISC_TYPE and the LEGAL_TYPE attributes found in respective .dbf files within the .gdb 
 * "M248UC_LUT", look up table for the state use codes found in the assessing table
