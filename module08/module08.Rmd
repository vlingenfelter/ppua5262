...
To get at the luxury of homes in Revere from tax assessor data, I chose to aggregate several manifest variables. These variables include: 
 - Yard size of a parcel
 - Number of rooms
...
singleFamily$LUXURY <- scale(singleFamily$LUXURY, center = TRUE, scale = TRUE)
...
# find average building value aggregated by building style for single family homes
valByStyle <- aggregate(singleFamily$TOTAL_VAL ~ singleFamily$STYLE, FUN = median)
# correct the column names
names(valByStyle) <- c('STYLE', 'LUXURY')
# sort by building value (high value to low value)
valByStyle <- valByStyle[order(-valByStyle$LUXURY),]
...
dotchart(buildingByStyle$LUXURY, 
         ...
         cex=.9,
         pch=17,
         main="MEDIAN SINGLE FAMILY HOME VALUE BY LUXURY SCORE",
         xlab="AVERAGE LUXURY",
         col = "#F98866",
         family = "mono",
         col.main = "#274F3B",
         col.lab = "#274F3B",
         fg = "#80BD9E")
dotchart(valByStyle$LUXURY, 
         labels=valByStyle$STYLE, 
         cex=.9,
         pch=17,
         main="MEDIAN SINGLE FAMILY HOME VALUE BY STYLE",
         xlab="AVERAGE TOTAL VALUE",
         col = "#F98866",
         family = "mono",
         col.main = "#274F3B",
         col.lab = "#274F3B",
